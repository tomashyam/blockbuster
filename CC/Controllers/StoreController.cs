...
namespace CC.Controllers
{
    public class StoreController : Controller
    {
        ...
        {
            var wantedStore = _storeBl.GetStoreById(id);
            return View("Views/Store/ByStoreId.cshtml", wantedStore);
        }
        ...
        public ActionResult Create()
        {
            if (!IsAdminConnected())
            {
                return RedirectToAction("Index", "Error", new { error = "only admin allow to edit. please go to admin page" });
            }
        ...
        private string StoreValidation(Cinema store)
        {
