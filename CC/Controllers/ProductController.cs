...
namespace CC.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create(int id, [Bind("ID", "Name", "Price", "ImageUrl", "Category", "Description")] Movie product)
        {
            try
            {
                var errorMessage = ProductValidation(product);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, [Bind("ID", "Name", "Price", "ImageUrl", "Category", "Description")] Movie product)
        {
            try
            {
        ...
        private string ProductValidation(Movie product)
        {
